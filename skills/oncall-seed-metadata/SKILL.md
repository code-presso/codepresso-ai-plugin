...
|----------------|-----------------------------|----------------------------|
| 마경욱         | kyeongwookma                | kyeongwook.ma@codepresso.kr |
| 이명석         | codepresso-MyoungSeokLee    | mslee@codepresso.kr        |
| 김은비         | codepresso-EunBiKim         | eunbi.kim@codepresso.kr    |
| 최유림         | codepresso-YuRimChoi        | urim.choi@codepresso.kr    |
| 이두리         | codepresso-DuReeLee          | drlee@codepresso.kr        |
| 임성학         | codepresso-SeongHakIm       | shyim@codepresso.kr        |
| 이윤혁         | codepresso-YounHyukLee      | yhlee@codepresso.kr        |
...
4. For each engineer, write a DynamoDB item:
   ...
   aws dynamodb put-item --table-name oncall-assignments-history --region ap-northeast-2 \
     --item '{
       "AssignmentDate": {"S": "ENGINEER#마경욱"},
       "Engineer": {"S": "마경욱"},
       "Role": {"S": "Meta"},
       "GitHubUsername": {"S": "kyeongwookma"},
       "Email": {"S": "kyeongwook.ma@codepresso.kr"}
     }'
   ```
