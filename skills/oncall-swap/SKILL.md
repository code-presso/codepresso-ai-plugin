...
6. Optionally notify via Google Chat webhook (ask user):
   ...
   curl -X POST -H 'Content-Type: application/json; charset=UTF-8' \
     ...
     'https://chat.googleapis.com/v1/spaces/AAQAxpZZ_aE/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=6BdH0oElPd5Uy5sXjDcdlT-UHKCiF3F1dFp__-sMfYk'
   ```
