...
#
# Prerequisites (already provisioned as of 2026-07-16):
# 1. Service account: sentinel-chat-bot@sentinel-501009.iam.gserviceaccount.com
#    (key stored in Secrets Manager: sentinel/google-chat-sa)
# 2. Oncall Google Calendar shared with the service account (writer role)
# 3. Lambda role has inline policy 'oncall-google-sa-secret-read'
#    allowing secretsmanager:GetSecretValue on sentinel/google-chat-sa
# 4. Google Calendar API must be ENABLED in GCP project sentinel-501009
...
env['GOOGLE_CREDENTIALS_SECRET'] = 'sentinel/google-chat-sa'
