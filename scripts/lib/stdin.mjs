/**
 * Shared stdin utilities for Codepresso hook scripts.
 * Timeout-protected stdin reading to prevent hangs on Linux and Windows.
 * Pattern from oh-my-claudecode/scripts/lib/stdin.mjs
 *
